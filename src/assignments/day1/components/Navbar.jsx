  ...
  return (
    <>
      <div className='overflow-hidden border-b border-white/10 bg-slate-950/75 text-white shadow-lg shadow-cyan-950/10 backdrop-blur'>
        <div className='mx-auto flex max-w-6xl flex-col gap-8 px-6 py-8 lg:flex-row lg:items-center lg:justify-between lg:px-10'>
...
const Logo = () => {
  return (
    <div className='flex items-center gap-3'>
      <div className='grid h-12 w-12 place-items-center rounded-2xl bg-cyan-500/15 text-cyan-300 ring-1 ring-cyan-400/20'>
        R
      </div>
      <div>
        <p className='text-xs font-semibold uppercase tracking-[0.35em] text-cyan-300'>Day 1</p>
        <p className='text-2xl font-bold'>Component Basics</p>
      </div>
    </div>
  )
}

  ...
  return (
   <>
          <div className='flex flex-col gap-4 border-b border-white/10 bg-slate-950/75 px-6 py-5 text-white shadow-lg shadow-cyan-950/10 backdrop-blur md:flex-row md:items-center md:justify-between md:px-10'>
              <div>
                <p className='text-xs font-semibold uppercase tracking-[0.35em] text-cyan-300'>Day 3</p>
                <div className='text-2xl font-bold sm:text-3xl'>Special Class</div>
              </div>
              <div className='flex flex-wrap items-center gap-4 text-sm font-medium text-slate-200'>
                  <Link className='transition hover:text-cyan-300' to={'/emp'}>Employee</Link>
                  <Link className='transition hover:text-cyan-300' to={'/products'}>Product</Link>
                  <Link className='transition hover:text-cyan-300' to={'/student'}>Student</Link>
